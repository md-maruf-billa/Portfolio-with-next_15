...
const CreateBlogPage = () => {
      ...
      return (
            <div className="container mx-auto mt-24 flex justify-center items-center">
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full max-w-4xl">
                        ...
                        <div className='flex justify-between items-center gap-5'>
                              ...
                              <div className='w-full md:w-1/2'>
                                    <div>
                                          <label htmlFor="projectImage" className="block text-sm font-medium">Project Image URL</label>
