...
const ProjectDetailsPage = async ({ params }: { params: Record<string, string> }) => {
                              ...
                              <div className="lg:max-w-lg">
                                    ...
                                    <div className='mt-6 '>
                                          ...
                                          <div className='mt-2 flex items-center gap-5 *:text-customSelect *:border-2 *:rounded-full *:border-customSelect *:p-2 *:text-xs '>
                                                <a href={projectData?.liveLink} target='_blank' className='hover:text-black hover:bg-customSelect flex items-center gap-2 text-customSelect border-2 rounded-full border-customSelect p-2 text-xs '> <BsBrowserEdge />Live-link</a>
                                                <a href={projectData?.frontEndGitRepo} target='_blank' className='hover:text-black hover:bg-customSelect flex items-center gap-2'> <FaGithub />Front-end</a>
                                                <a href={projectData?.backEndGitRepo} target='_blank' className='hover:text-black hover:bg-customSelect flex items-center gap-2'> <FaGithub />Back-end</a>
                                          </div>
                                    </div>
                              </div>
                        </div>
