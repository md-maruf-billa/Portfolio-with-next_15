...
export default function Banner() {
      ...
      return (
            <div id='home' className='flex flex-col md:flex-row gap-5 justify-center px-4 items-center py-20 '>
                  ...
                  <div>
                        ...
                        <div className='space-y-4'>
                              ...
                              <p className='md:text-xl'>
                                    I am a Frontend web developer. I am always curious to learn new technology and apply it to projects. I love contribute to web or MERN projects and find collaborators.
                              </p>

                              <div className='flex items-center gap-5 *:text-customSelect *:border-2 *:rounded-full *:border-customSelect *:p-2 *:text-xl '>
                                    <a href='https://www.facebook.com/profile.php?id=100027753881743&mibextid=ZbWKwL' target='_blank' className='hover:text-black hover:bg-customSelect'> <FaFacebook /></a>
                                    <a href='https://x.com/Abumahidislam' target='_blank' className='hover:text-black hover:bg-customSelect'><FaTwitter /></a>
                                    <a href='#' className='hover:text-black hover:bg-customSelect'><FaInstagram /></a>
                                    <a href='https://www.linkedin.com/in/md-abu-mahid-islam/' target='_blank' className='hover:text-black hover:bg-customSelect'><FaLinkedin /></a>
                              </div>
                  ...
                  <div>
                        <img src="https://abumahid-portfolio.netlify.app/assets/profiledp-8-CD7nSm.png" alt="" />
                  </div>
